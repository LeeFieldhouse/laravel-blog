...
<div class="post-image ml-0">
                        ...
                        <div class="post-content ml-0">
                            ...
                            <h2 class="font-weight-bold"><a href="{{route('posts.show', $post->slug)}}">{{$post->title}}</a></h2>
                            ...
                            <div class="post-meta">
                                ...
                                <span><i class="far fa-comments"></i> <a href="#comments">12 Comments</a></span>
                                @if(Auth::user()->id == $post->user->id)
                                    <span><i class="far fa-edit"></i><a href="{{route('posts.edit', $post->slug)}}">Edit</a></span>
                                @endif
                            </div>
...
<div id="comments" class="post-block mt-5 post-comments">
                                <h4 class="mb-3" id="comments">Comments (3)</h4>
